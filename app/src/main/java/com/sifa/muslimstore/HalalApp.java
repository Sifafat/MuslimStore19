...
import com.sifa.muslimstore.API;
import com.sifa.muslimstore.DataHalal;
import com.sifa.muslimstore.HalalAdapter;
import com.sifa.muslimstore.ProdukHalal;
        ...
        btn_cari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(keyword.getText())){
                    ...
                    Toast.makeText(HalalApp.this, "Masukkan nama barang, nama produsen atau nomor sertifikat.",
